...
<html>
	...
	<div class="gtco-section align-center">
		<div style="width:50%; margin: 0px auto">
			<div class="flex-grow flex flex-col gap-16  calendarFlight" style="max-width: 2000px;">
				<div class="Card-card">
				<div class="Card-card-customer" id="customerId1">

					<div class="Customer-info-header" id="eventDiv">
						<div class="subheading md">Hãy điền thông tin của bạn</div>
					</div>	
				...
				<div class="Card-card-customer" id="customerId2">
					...
					if(isset($_SESSION['tour_id'])) {
						...
						if ($result_tour_details->num_rows > 0) {
							...
							echo "<h4 style='padding: 10px 24px; margin-top: 10px;' >Thông tin chi tiết tour:</h4>";
							echo "<div class='thongtinchitiettour' style='display:flex; gap:14px ; padding: 0px 24px'>";
							echo "<img src=\"/BayWithVaa/img/" . $row['HinhAnh'] . "\" alt=\"" . $row['TenTour'] . "\" width=\"300\" height=\"200\">";
						...
						<div class="flex flex-col gap-24">
							...
							<div class="grid grid-cols-2 gap-16">
								<div class="Customer-info-select-input">
									<div class="relative">
										<div class="subheading md">Thông tin thêm</div>
									</div>
								</div>
								<label>Địa chỉ nhà:				
									<div class="">
