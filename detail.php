...
<div class="news-container">    
    <?php
 // Kiểm tra nếu ID bài viết được truyền qua URL
if(isset($_GET['id'])) {
    $id_news = $_GET['id'];
    ...
    if ($result_detail->num_rows > 0) {
        ...
        while($row_detail = $result_detail->fetch_assoc()) {
            ...
            echo "<img src='/BayWithVaa/img/" . $row_detail['AnhBaiViet'] . "' alt='Ảnh bài viết'>";
            echo "<p><strong>Ngày đăng:</strong> " . $row_detail['NgayDang'] . "</p>";
            echo "<p><strong>Mô tả:</strong> " . $row_detail['MoTa'] . "</p>";
