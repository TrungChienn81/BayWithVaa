		...
		<div class="row">
			<div class="col-md-4 text-center">
				<div class="gtco-widget">
					<h3> Du thuyền Âu Cơ</h3>
					<p></p>
				</div>
				<div class=" ShipDetail_badge-list">
					<div class="badge-container">
						<label class="badge-container">5 (0 đánh giá) </label>
					</div>
				</div>
			</div>
...
<!--
	<div class="container">
		<div class="slider-wrapper">
			<div class="img-list" >
				<img src="images/duthuyenauco.png" alt="du thuyen au co" class="image-item" style="width: 325px"; >
				<img src="images/duthuyenauco2.png" alt="du thuyen au co" class="image-item" style="width: 325px";>
				<img src="images/duthuyenauco3.png" alt="du thuyen au co" class="image-item" style="width: 325px";>
			</div>
		</div>
	</div>
-->
	<div class="gtco-counter">
	...
	<div class"ProductCard_list__r7WEn"></div>
