										...
										<div class="tab-content-inner active" data-content="signup">
											...
											<!--<div class="row form-group">
												...
												<div class="row form-group">
													...
													<div class="row form-group">
														<div class="col-md-12">
															<label for="price-range">Chọn giá vé bạn muốn</label>
															<select name="price-range" id="price-range" class="form-control">
																<option value="1">Dưới 500,000đ</option>
																<option value="2">Từ 500,000 đến 1,000,000 triệu</option>
																<option value="3">Từ 1,000,000 đến 2,000,000 triệu</option>
																<option value="4">Trên 2,000,000 triệu</option>
															</select>
														</div>
													</div>
												<div class="row form-group">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/Dalatimg.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p><span id="btnDL" class="btn btn-primary">Khám phá</span></p>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/SonDongimg.png" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p><span id="btnDH" class="btn btn-primary">Khám phá</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/Hueimg.png" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p><span id="btnH" class="btn btn-primary">Khám phá</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/Nhatrangimg.png" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p><span id="btnNT" class="btn btn-primary">Khám phá</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/Condaoimg.png" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p><span id="btnCD" class="btn btn-primary">Khám phá</span></p>
						</div>
					</a>
				</div>
...
<script>
    document.getElementById("btnPQ").addEventListener("click", function() {
        window.open("ket-qua.php?location=Phú Quốc", "_blank");
    });
</script>
<script>
    document.getElementById("btnDL").addEventListener("click", function() {
        window.open("ket-qua.php?location=Đà Lạt", "_blank");
    });
</script>
<script>
    document.getElementById("btnDH").addEventListener("click", function() {
        window.open("ket-qua.php?location=Đồng Hới", "_blank");
    });
</script>
<script>
    document.getElementById("btnH").addEventListener("click", function() {
        window.open("ket-qua.php?location=Huế", "_blank");
    });
</script>
<script>
    document.getElementById("btnNT").addEventListener("click", function() {
        window.open("ket-qua.php?location=Nha Trang", "_blank");
    });
</script>
<script>
    document.getElementById("btnCD").addEventListener("click", function() {
        window.open("ket-qua.php?location=Côn Đảo", "_blank");
    });
</script>
	</body>
</html>
