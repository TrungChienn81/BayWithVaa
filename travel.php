    ...
    <form action="tour.php" method="get" target="_blank">
        ...
        <p>Điểm đi</p>
			...
			if ($result_from->num_rows > 0) {
				...
				echo "<option value='0'>-- Chọn địa điểm bạn muốn đi --</option>";
    ...
    <div class="container">
        ...
        <div class="nice-place-content row">
            ...
            <div class="nice-place-text">
                ...
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <p>Vùng Tây Bắc hay Tây Bắc Bộ là vùng miền núi phía tây của miền Bắc Việt Nam. Vùng này là một trong 3 phần của Bắc Bộ Việt Nam </p>
                <a class="btn" href="ket-qua.php?location=Tây Bắc" target="_blank">Khám phá</a>
            </div>
        </div>
        <div class="nice-place-item">
                <div class="nice-place-img">
            ...
            <div class="nice-place-text">
                ...
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <p>Thành phố Hồ Chí Minh (viết tắt TP.HCM) là trung tâm kinh tế, giải trí, một trong hai trung tâm văn hóa và giáo dục quan trọng tại Việt Nam.</p>
                <a class="btn" href="ket-qua.php?location=Thành phố Hồ Chí Minh" target="_blank">Khám phá</a>
            </div>
        </div> 
        <div class="nice-place-item">
                <div class="nice-place-img">
            ...
            <div class="nice-place-text">
                ...
                <a class="btn" href="ket-qua.php?location=Hà Nội" target="_blank">Khám phá</a>
            </div>
        </div>    
    </div>
</div>
...
<section class="contact">
	<form method="post" action="xuly-contract.php" id="myform" target="_blank">
    <div class="container">
